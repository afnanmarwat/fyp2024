...
function Jobitem({ item, jobApply }) {
  ...
  return (
    <div className="border-2 w-[100%] h-full rounded-xl px-6 py-2 ml-4 mr-4 hover:drop-shadow-xl hover:bg-white hover:border-blue-400 hover:cursor-pointer  transition-all ease-in-out duration-100">
