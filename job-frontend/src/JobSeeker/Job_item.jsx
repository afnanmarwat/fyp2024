...
function Jobitem({ item, jobApply }) {
  ...
  return (
    <div className="border-1 w-[70%] h-full rounded-xl px-3 py-4 hover:border-[#1a75e8] hover:drop-shadow-xl hover:bg-white  hover:cursor-pointer transition-all ease-in-out duration-100">
