...
const Navigation = () => {
  ...
  return (
    // Navbar
    <nav className="w-full fixed top-0 h-[50px] px-3 py-1  font-semibold">
      <div className="w-full flex flex-row justify-between items-center">
        ...
        <NavLink
          ...
          className="flex gap-1 justify-center items-center text-[#0f1137] text-xl font-medium "
          to="/dashboard"
        >
          {/* icon */}
          <span className="">
        ...
        <div>
          ...
          <Dropdown>
            <Dropdown.Toggle className="bg-gray-200 text-[#0f1137] rounded-full flex items-center justify-center border-none hover:bg-none">
              <span>
